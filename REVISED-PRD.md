...
date: 2026-05-16
app_id: train
app_name: DClaw Train
category: L&D
status: Future
---

# 📘 DClaw Train — Revised PRD v2.3
...
| **Color** | #10B981 |
| **Phase** | Future |
| **Port (Frontend Dev)** | 3017 (TBD — assign before build) |
| **Port (Backend Dev)** | 18087 (TBD — assign before build) |
...
|---|---------|-------------|--------------|---------------------|
| P0.1 | **AI Training Copilot** | Personalized training assistant that answers questions and guides employees. | RAG over training materials + conversational LLM | Answer accuracy >90% from company knowledge base |
| P0.2 | **Course Catalog & Assignments** | Organize training content and assign to employees/groups. | AI learning-path recommendation based on role | Role-based auto-assignment; due-date tracking |
| P0.3 | **Skill Assessment** | Quizzes and practical evaluations with AI grading. | LLM-based open-ended response evaluation | Auto-grade 5 question types; practical evaluation rubrics |
| P0.4 | **Compliance Tracking** | Track completion of mandatory training (HIPAA, SOC2, etc.). | AI deadline-risk prediction + reminder optimization | 100% compliance visibility; auto-escalate overdue training |
...
| # | Feature | Description | AI Component | Acceptance Criteria |
|---|---------|-------------|--------------|---------------------|
| P1.1 | **Certification Management** | Issue and verify internal certifications with expiry tracking. | AI renewal recommendation based on role changes | PDF certificates; expiry alerts; re-certification workflows |
| P1.2 | **Training Analytics** | Dashboard of completion rates, scores, and skill gaps. | AI skill-gap prediction + team-readiness scoring | Track 20+ metrics; identify top 3 skill gaps per team |
| P1.3 | **Video Training** | Host and track video training with AI-generated chapters. | AI chapterization + transcript search | Auto-chapters in <60s; searchable transcript; progress tracking |
| P1.4 | **Integration with HR** | Sync employee data from DClaw HR for auto-enrollment. | API sync + change-event propagation | Real-time sync; auto-enroll new hires; offboard access revocation |
...
| # | Feature | Description | AI Component | Acceptance Criteria |
|---|---------|-------------|--------------|---------------------|
| P2.1 | **VR Training Simulations** | Immersive training scenarios for high-risk roles. | AI scenario-generation + performance feedback | Browser-based VR; 10+ scenario templates |
| P2.2 | **Mentorship Matching** | AI-match employees with mentors based on goals and skills. | Embedding-based compatibility scoring | Match accuracy >75%; schedule auto-sync |
| P2.3 | **Gamification** | Points, badges, and leaderboards to drive engagement. | AI challenge-difficulty calibration | 5 gamification mechanics; team + individual leaderboards |
| P2.4 | **External Content Import** | Import LinkedIn Learning, Udemy, and custom SCORM packages. | AI content-quality scoring + deduplication | SCORM 1.2/2004; xAPI; progress sync |
...
Inspired by Docebo, Cornerstone, 360Learning. Corporate training is a $350B market ripe for AI disruption.
