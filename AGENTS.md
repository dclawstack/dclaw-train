...
**DClaw Train** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8039` (FastAPI)
- **Frontend Port:** `3039` (Next.js)
- **Database:** `dclaw_train` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3039`
